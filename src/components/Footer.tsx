  ...
  return (
    <footer className="mt-auto border-t border-line bg-navy text-white">
      <div className="mx-auto grid max-w-6xl gap-10 px-5 py-14 md:grid-cols-3 md:px-8">
        <div>
          <div className="mb-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/70">{company.years}</p>
            </div>
          </div>
        ...
        <div>
          <h2 className="mb-4 font-display text-lg text-white">Navegación</h2>
        ...
        <div>
          <h2 className="mb-4 font-display text-lg text-white">Información</h2>
